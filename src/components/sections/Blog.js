        ...
        <div className="row border-line-v">
          ...
          <div className="col col-d-6 col-t-6 col-m-12">
            <div className="box-item">
              <div className="image">
                <a href="#" onClick={() => changeNav("blog-post")}>
                  <img
                    ...
                    alt="An Introductory Course to Cloud Computing"
                  />
                  <span className="info">
              ...
              <div className="desc">
                <a href="#" onClick={() => changeNav("blog-post")}>
                  <span className="date">October 21, 2023</span>
                </a>
                <a
                  href="#"
                  ...
                  className="name"
                >
                  An Introductory Course to Cloud Computing
                </a>
                <div className="text">
                  <p>
                    Cloud computing is a transformative computing paradigm that delivers computing services like servers, storage, databases…
                  </p>
                </div>
              </div>
            </div>
